...
c	High Stimulus High Initial Condition
c.............................................................................
c     Adipogenic Model at a constant signal
	...
	open(1002,file='high_stim_high_ic.out',status='unknown')
...
c     -----------------------------------------------------------------
        nk=1500   !Stochastic simulation run, analogue of cell count
...
c       write(filename,'("pulse_",I4.4,".out")') nm
c       open(1001,file=filename,status='unknown')
c.....................................................................
...
c......................................................................
c        if (mod(nrxn,10000).eq.0) then
c                 write(1001,*) ti,nmPPARG,nPPARGi,nPPARGa,nmCEBPA,
c     #nCEBPA,nmFABP4,nFABP4,stim
c         end if
...
c		write(*,*) nadipo
 ...
 201	write(*,*) nm,nadipo,'Done'
	write(1002,*) nm, nPPARGa ! cell_id  last PPARGa exp
 200    continue
c       end do
c........................................................................
