...
c	Pulsatile Signal
c.............................................................................
c     PPARG Model coupled with Circadian network (Integrated Model)
...
c     -----------------------------------------------------------------
        nk=400   !Stochastic simulation run, analogue of cell count
        l100=117 ! random number seed
c.....................................................................
...
c      call random_seed
	...
	nm = jj + 00
       ...
       write(filename,'("pulse_",I5.5,".out")') nm
...
c.....................................................................
  10     sfcirc = 1000 ! scaling factor for whole circadian network
	 sfper = 10 ! individual scaling of Per protein
	 sfrev = 1.5 ! individual scaling of Rev protein
	 sfrev1 = 0.5 ! individual scaling of Per mRNA 
	 ax = 0.728 ! rate regulatory factor
	 aksbmal1p = 0.06*sfcirc*ax
	 aJbmal1p = 2
	 aKmpercry = 0.007*sfcirc
	 aksbmal1r = 0.001*sfcirc*ax
	 aJbmal1r = 1
	 aKmrev = 0.005*sfcirc*sfrev
	 akdbmal1 = 0.0031*ax
	 abmper = 0.1*sfcirc*ax
	 aksmper = 0.25*ax
	 akGC = 0.008*ax
	 akdmper = 0.25*ax
	 aksper = 0.2156*sfper*ax
	 akdper = 0.03*ax
	 aka = 0.1415*ax
	 akd = 0.004716*ax
	 akper = 3.2478*ax
	 aJ = 0.04
	 akpercry = 0.003773*ax
	 akdpercry = 0.015*ax
	 aq = 1/(sfcirc*sfper)
	 ar = 2.2/sfcirc
	 abGC = 0.005*sfcirc*ax
	 aksGC = 0.015*sfcirc*ax
	 aJGC = 1
	 aKmGC = 0.05*sfcirc*sfper
	 am = 2
	 akdGC = 0.01*ax
	 abmrev = 0.1*sfcirc*ax*sfrev1
	 aksmrev = 0.4*ax*sfrev1
	 akdmrev = 0.25*ax
	 akrgc = 0.2*ax*sfrev1
	 aksrev = 0.1*sfcirc*ax*sfrev
	 aJrev = 2*sfcirc*sfrev1
	 ah = 2
	 akdrev = 0.35*sfcirc*ax*sfrev
	 aJdrev = 5*sfcirc*sfrev 

	 if (ti.ge.0) then 
		stim = 4.0*(nGC-400)/(2000-400) 
	 else 
	 	stim = 0
	 end if
c	stim = 4*(GC(at each time point)-GC_approx_min(400))/(GC_approx_max(2000)-GC_approx_min(400))
...
c      Reactions for the problem   	
	 ...
	 a_nu(1)= aksbmal1p/(aJbmal1p+(nPerCry/aKmpercry))
	 a_nu(2)= aksbmal1r/(aJbmal1r+(nRev/aKmrev))
	 a_nu(3)= akdbmal1*nBmal1
	 a_nu(4)= abmper
	 a_nu(5)= aksmper*nBmal1
	 a_nu(6)= akGC*nGC
	 a_nu(7)= akdmper*nmPer
	 a_nu(8)= aksper*nmPer
	 a_nu(9)= aka*nPer/sfper
	 a_nu(10)= akd*nPerCry
	 a_nu(11)= akdper*nPer
	 a_nu(12)= (akper*nPer)/(aJ+aq*nPer+ar*nPerCry)
	 a_nu(13)= akdpercry*nPerCry
	 a_nu(14)= (akpercry*nPerCry)/(aJ+aq*nPer+ar*nPerCry)
	 a_nu(15)= abGC
	 a_nu(16)= aksGC/(aJGC**am+(nPer/aKmGC)**am)
	 a_nu(17)= akdGC*nGC
	 a_nu(18)= abmrev
	 a_nu(19)= aksmrev*nBmal1
	 a_nu(20)= akdmrev*nmRev
	 a_nu(21)= akrgc*nGC
	 a_nu(22)= (aksrev*nmRev**ah)/(aJrev**ah+nmRev**ah)
	 a_nu(23)= (akdrev*nRev)/(aJdrev+nRev)
	 a_nu(24)= aksP
	 a_nu(25)= (akP1*nCEBPA**2)/(akmP1**2+nCEBPA**2)
	 a_nu(26)= (akP2*nFABP4**2)/(akmP2**2+nFABP4**2)
	 a_nu(27)= akdmP*nmPPARG
	 a_nu(28)= aktP*nmPPARG
	 a_nu(29)= akinact*nPPARGa
	 a_nu(30)= ak0*nPPARGi
	 a_nu(31)= akact*stim*nPPARGi
	 a_nu(32)= akdP*nPPARGi
	 a_nu(33)= akdP*nPPARGa
	 a_nu(34)= bmCEBPA
	 a_nu(35)= (akC*nPPARGa**2)/(akmC**2+nPPARGa**2)
	 a_nu(36)= akdmC*nmCEBPA
	 a_nu(37)= aktC*nmCEBPA
	 a_nu(38)= akdC*nCEBPA
	 a_nu(39)= bmFABP4
	 a_nu(40)= (akF*nPPARGa**2)/(akmF**2+nPPARGa**2)
	 a_nu(41)= akdmF*nmFABP4
	 a_nu(42)= aktF*nmFABP4
	 a_nu(43)= akdF*nFABP4
...
c......................................................................
 100	 go to(101,102,103,104,105,106,107,108,109,110,111,112,113,114,
     ...
     $131,132,133,134,135,136,137,138,139,140,141,142,143),mu
 ...
 112	 nPer = nPer-1
	 go to 50
 113	 nPerCry = nPerCry-1
	 go to 50
 114	 nPerCry = nPerCry-1
	 go to 50
 115 	 nGC = nGC+1
	 go to 50
 116	 nGC = nGC+1
 ...
 123	 nRev = nRev-1
	 go to 50
 124	 nmPPARG = nmPPARG+1
	 go to 50
 125     nmPPARG = nmPPARG+1
         go to 50
 126     nmPPARG = nmPPARG+1
         go to 50
 127     nmPPARG = nmPPARG-1
	 go to 50
 128	 nPPARGi = nPPARGi+1
	 go to 50
 129	 nPPARGi = nPPARGi+1
	 nPPARGa = nPPARGa-1
	 go to 50
 130	 nPPARGa = nPPARGa+1
	 nPPARGi = nPPARGi-1
	 go to 50
 131	 nPPARGi = nPPARGi-1
	 nPPARGa = nPPARGa+1
	 go to 50
 132	 nPPARGi = nPPARGi-1
	 go to 50
 133	 nPPARGa = nPPARGa-1
	 go to 50
 134	 nmCEBPA = nmCEBPA+1
	 go to 50
 135	 nmCEBPA = nmCEBPA+1
	 go to 50
 136	 nmCEBPA = nmCEBPA-1
	 go to 50
 137 	 nCEBPA = nCEBPA+1
	 go to 50
 138	 nCEBPA = nCEBPA-1
	 go to 50
 139	 nmFABP4 = nmFABP4+1
	 go to 50
 140	 nmFABP4 = nmFABP4+1
	 go to 50
 141	 nmFABP4 = nmFABP4-1
	 go to 50
 142	 nFABP4 = nFABP4+1
	 go to 50
 143	 nFABP4 = nFABP4-1
...
c......................................................................
        if (mod(nrxn,100000).eq.0) then
                 write(1001,*) ti,nmPPARG,nPPARGi,nPPARGa,nmCEBPA,
     #nCEBPA,nmFABP4,nFABP4,stim,nBmal1,nmPer,nPer,nPerCry,nGC,nmRev,
     #nRev
         end if
